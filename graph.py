...
def generate_graph(seed: int):
    ...
    all_tasks = {
        ...
        "2_medium_congestion": ScenarioTemplate(
            ...
            description="Heavy traffic blocks key diagonal routes. Navigate by coordinates to find a detour.",
            start_node="N0", destination_node="N15",
            deadline_minutes=int(optimal_clear_time * 1.4 + 20),
            initial_fuel=baseline_fuel * 1.1,
            initial_weather={"NW": "Clear", "NE": "Clear", "SW": "Clear", "SE": "Clear"},
            traffic_schedule=[
                TrafficEvent(0, "N2->N6", "Severe", 999),
                TrafficEvent(0, "N6->N10", "Severe", 999),
                TrafficEvent(0, "N10->N11", "Heavy", 999),
            ],
        ),
        ...
        "4_frontier_greedy_trap": ScenarioTemplate(
            ...
            initial_fuel=baseline_fuel * 0.95,
            initial_weather={"NW": "Clear", "NE": "Clear", "SW": "Clear", "SE": "Clear"},
            weather_schedule=[
